    ...
    >
      <div className={s.inner_content}>
        ...
        <div className={s.subtitle}>
          Для дальнейшего просмотра данного Сайта вам необходимо ознакомиться с{' '}
          <a href="/files/terms.pdf">Пользовательским соглашением</a> и подтвердить свое
          совершеннолетие.
          <br />
          <br />
          Данный Сайт не является рекламой, так как предназначен для ограниченного круга лиц, а
          именно для совершеннолетних потребителей табачной продукции (граждан России старше 18 лет)
          для предоставления им достоверной информации об основных потребительских свойствах и
          качественных характеристиках табачной продукции и аксессуарах для курения (п.1 и п.2 ст.10
          Закона «О защите прав Потребителя»). В соответствии с ФЗ №15 «Об охране здоровья граждан»
          мы не осуществляем дистанционную торговлю табачной продукцией, табачными изделиями или
          никотинсодержащей продукцией, кальянами, устройствами для потребления никотинсодержащей
          продукции.
          <br />
          <br />
          Лицам, не достигшим совершеннолетия, пользование Сайтом запрещено (ст. 20 ФЗ №15 «Об
