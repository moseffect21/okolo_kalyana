  ...
  return (
    <div className={s.container}>
      <div className={s.social_icons}>
        <a
          href="https://www.instagram.com/okolo_kalyana/"
          className={`${s.social_item} ${s.inst}`}
          target="_blank"
          rel="noreferrer"
        >
        ...
        <a
          href="https://vk.com/blog_hookah"
          className={`${s.social_item} ${s.vk}`}
          target="_blank"
          rel="noreferrer"
        >
        ...
        <a
          href="https://t.me/okolokalyana"
          className={`${s.social_item} ${s.tg}`}
          target="_blank"
          rel="noreferrer"
        >
